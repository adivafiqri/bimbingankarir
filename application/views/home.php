        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 banner-left">
                    ...
                    <h3 data-aos="fade-down" data-aos-delay="300" class="text-transpert mt-3" style="color: #fff">Prodi Bimbingan dan Konseling</h3>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 footer-left">
                ...
                <p class="copyright-text">&copy; 2023
                    <a href="" target="_blank">Bimbingan Karir</a>
                </p>
            </div>
            <div class="col-lg-7">
